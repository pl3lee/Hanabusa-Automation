...
def scrape(website, username, password, propertystate, propertycity, propertyarea):
    ...
    # checks city
    browser.find_element_by_xpath('//*[@id="editor-post-taxonomies__hierarchical-terms-filter-4"]').send_keys(propertycity)
    ...
    # checks area
    if propertyarea != "None":
        browser.find_element_by_xpath('//*[@id="editor-post-taxonomies__hierarchical-terms-filter-5"]').send_keys(propertyarea)
    ...
    autocomplete = browser.find_element_by_class_name('ui-menu-item')
    autocompletetext = autocomplete.find_element_by_class_name('ui-menu-item-wrapper').text
    autocomplete.find_element_by_class_name('ui-menu-item-wrapper').click()
    # enters autocomplete address to title
    browser.find_element_by_xpath('//*[@id="post-title-0"]').send_keys(autocompletetext)

    # selects media tab
    autocomplete.find_element_by_xpath('//*[@id="houzez-property-meta-box"]/div[2]/div/div/ul/li[4]/a').click()
